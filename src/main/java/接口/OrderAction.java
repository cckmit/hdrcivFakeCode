...
public class OrderAction {
    ...
    public void getOrders(String patientId, String orderStatus, String orderProperty, String orderType,
                          String orderTimeBegin, String orderTimeEnd, String keyWord, String orderBy, String orderDir, int pageNo,
                          int pageSize, String outPatientId, String visitType) {


        /* 将 keyWord 的括号去掉，取出药品名称*/
        String orderName = keyWord.replace("(", "").replace(")", "");
        /*将参数传给逻辑层*/
        orderService.getOrders(patientId, orderStatus, orderProperty, orderType,
                orderTimeBegin, orderTimeEnd, orderName, orderBy, orderDir, pageNo,
                pageSize, outPatientId, visitType);
